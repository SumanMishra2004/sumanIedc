...
export function ChartAreaGradient({ monthlyTrend, dailyTrend, weeklyTrend, total }: ChartAreaGradientProps) {
    ...
    <Card className="flex flex-col border-dashed border-2 border-chart-2">
      <CardHeader className="pb-2">
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-base">Publication Trend</CardTitle>
            <CardDescription className="text-xs">
              Journals created over the {getPeriodLabel()}
            </CardDescription>
          </div>
      ...
      <CardContent className="pb-2">
        <ChartContainer config={chartConfig} className="h-[200px] w-full">
          ...
          >
            ...
            />
            <defs>
              <linearGradient id="fillJournalCount" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
