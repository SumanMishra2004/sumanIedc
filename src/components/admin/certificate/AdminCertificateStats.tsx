...
import { CertificateStatsResponse } from "@/types/certificate"
...
const trendChartConfig: ChartConfig = {
  count: { label: "Certificates", color: "var(--chart-2)" },
}

export default function AdminCertificateStats() {
  ...
  const privateCount = stats.privateCount
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Certificates by verification stage</CardDescription>
          </CardHeader>
          <CardContent>
            {statusData.length > 0 ? (
              <ChartContainer
