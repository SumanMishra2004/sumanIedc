...
import {
  ...
  Clock, Building, Award, MessageSquare
} from "lucide-react";
...
import { getCertificateById, updateCertificate } from "@/lib/research/certificateApi";
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-sm font-medium">
              {existingLabel ?? "Certificate document on file"}
            </p>
...
export default function CertificateEditForm({
  ...
  }, [certificateId, open, form, onOpenChange]);
  ...
  const onSubmit = async (values: CertificateFormValues) => {
    ...
    try {
      const cleanedValues = {
        ...
        dateOfCompletion: new Date(values.dateOfCompletion).toISOString(),
      };
  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent
          className="max-w-[98vw] w-4xl max-h-[92dvh] p-0 gap-0 overflow-hidden rounded-2xl border border-border/60 shadow-2xl"
          onInteractOutside={(e) => {
              ...
              <div className="flex items-start gap-3.5 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <DialogDescription className="text-sm text-muted-foreground mt-0.5">
                    Update certification course or achievement registration data
                  </DialogDescription>
                </div>
              </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="Certificate course title"
                    ...
                    <div className="lg:col-span-3 space-y-4">
                      ...
                      <FormField
                        ...
                        render={({ field, fieldState }) => (
                          <FormItem>
                            <FormLabel className="text-sm font-medium">
                              Certificate Document File <RequiredDot />
                            </FormLabel>
                            <FormControl>
                              <UploadZone
