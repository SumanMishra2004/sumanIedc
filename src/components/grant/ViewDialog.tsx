        ...
        <DialogHeader className="px-6 py-4 border-b bg-muted/40">
          <div className="flex items-center justify-between mr-8">
            <DialogTitle className="text-xl font-bold flex flex-wrap items-center gap-2">
              <span className="truncate max-w-[500px]">{grant?.projectCode || "Grant Details"}</span>
              {grant && (
        ...
        <ScrollArea className="flex-1 p-6">
          {loading ? (
            ...
            <div className="space-y-8">
                  ...
                  <CardContent className="pt-4 space-y-4">
                    <div className="flex justify-between items-center p-2 rounded hover:bg-muted/50 transition-colors">
                      ...
                      <span className="font-bold text-lg text-emerald-600">
                        {grant.amountGranted ? `₹${grant.amountGranted.toLocaleString()}` : "N/A"}
                      </span>
                    </div>
                    <Separator />
                    <div className="flex justify-between items-center p-2 rounded hover:bg-muted/50 transition-colors">
                      ...
                      <span className="font-bold text-lg text-blue-600">
                        {grant.usedAmount ? `₹${grant.usedAmount.toLocaleString()}` : "N/A"}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="pt-4 space-y-4">
                    <div className="flex justify-between items-center p-2 rounded hover:bg-muted/50 transition-colors">
                      ...
                      <span className="font-medium">
                        {grant.applicationDate 
                          ? format(new Date(grant.applicationDate), "PPP") 
                          : "N/A"}
                      </span>
                    </div>
                    <Separator />
                    <div className="flex justify-between items-center p-2 rounded hover:bg-muted/50 transition-colors">
                      ...
                      <span className="font-medium">
                        {grant.grantDate 
                          ? format(new Date(grant.grantDate), "PPP") 
                          : "Pending"}
                      </span>
                    </div>
                  </CardContent>
              ...
              {/* Mappings & Bills could go here later if needed */}
