...
import AdminConferenceStats from "@/components/admin/conference/AdminConferenceStats"
import AdminConferenceTable from "@/components/admin/conference/AdminConferenceTable"
  ...
  return (
    <div className="container mx-auto max-w-[1600px] p-6 space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Audit, review, verify, publish and manage all conference submissions.
        </p>
      </div>

      {/* Analytics Stats */}
      <AdminConferenceStats key={statsRefreshKey} />

      {/* Main Table */}
      <AdminConferenceTable onRefresh={handleRefreshStats} />
    </div>
  )
}
