...
import AdminPatentStats from "@/components/admin/patent/AdminPatentStats"
import AdminPatentTable from "@/components/admin/patent/AdminPatentTable"
  ...
  return (
    <div className="container mx-auto max-w-[1600px] p-6 space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Audit, review, verify, approve and manage all patent submissions.
        </p>
      </div>

      {/* Analytics Stats */}
      <AdminPatentStats key={statsRefreshKey} />

      {/* Main Table */}
      <AdminPatentTable onRefresh={handleRefreshStats} />
    </div>
  )
}
