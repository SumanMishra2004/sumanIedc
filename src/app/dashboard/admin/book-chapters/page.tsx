...
import AdminBookChapterStats from "@/components/admin/book-chapter/AdminBookChapterStats"
import AdminBookChapterTable from "@/components/admin/book-chapter/AdminBookChapterTable"
  ...
  return (
    <div className="container mx-auto max-w-[1600px] p-6 space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Audit, review, verify, publish and manage all book chapter submissions.
        </p>
      </div>

      {/* Analytics Stats */}
      <AdminBookChapterStats key={statsRefreshKey} />

      {/* Main Table */}
      <AdminBookChapterTable onRefresh={handleRefreshStats} />
    </div>
  )
}
